...
namespace Object2D
{
	...
	Mesh* CreateCircle(std::string name, glm::vec3 center, int radius, glm::vec3 color, bool fill);
	Mesh* CreateCircle2(std::string name, glm::vec3 center, int radius, glm::vec3 color, bool fill);
}
